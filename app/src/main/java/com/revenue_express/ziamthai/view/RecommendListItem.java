 ...
 */
public class RecommendListItem extends BaseCustomViewGroup {
    TextView tvName;
    TextView tvState;
    ImageView imgItem;
    ...
    public RecommendListItem(Context context, AttributeSet attrs) {
        super(context, attrs);
        initInflate();
        initInstances();
    ...
    public RecommendListItem(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    @TargetApi(21)
    public RecommendListItem(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
