...
public class SearchStateFragment extends Fragment {
    ...
    public SearchStateFragment() {
        super();
    }

    public static SearchStateFragment newInstance() {
        SearchStateFragment fragment = new SearchStateFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_search_state, container, false);
